...
public class SistemaMain {
    ...
    public static void menu(ArrayList<AgendaPagamento> listaAgenda,ArrayList<Empregado> listaEmpregados) {
        ...
        while (true){
            ...
            System.out.printf("=========================================%n" +
                    "[1] Adicionar um novo empregado%n[2] Remover empregado%n[3] Lançar um cartão de ponto%n" +
                    "[4] Lançar um resultado de venda%n[5] Lançar uma taxa de serviço%n[6] Alterar detalhes de um empregado%n[7] " +
                    "Rodar folha de pagamento%n[8] Voltar/Proceder%n[9] Agenda de pagamento%n[10] Criar nova agenda de pagamento%n" +
                    "=========================================%n");
            opcao = input.nextInt();
